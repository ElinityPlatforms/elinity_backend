...
import { MdHome, MdFavorite, MdAssignment, MdSearch, MdMessage, MdSettings, MdInfo, MdDelete, MdLogout, MdAccessTime, MdOutlineNotificationsNone, MdOutlineSettings, MdChevronLeft, MdPerson, MdMenuBook } from "react-icons/md";
import { FaMapMarkerAlt, FaBriefcase, FaHeart, FaGamepad } from "react-icons/fa";
import "../App.css";
