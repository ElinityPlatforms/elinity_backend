...
import { MdFavoriteBorder, MdFavorite, MdRefresh, MdMoreVert, MdPersonAddAlt, MdLightbulb, MdHome, MdFavorite as MdFavoriteIcon, MdAssignment, MdSearch, MdMessage, MdSettings, MdInfo, MdDelete, MdLogout, MdAccessTime, MdOutlineNotificationsNone, MdOutlineSettings, MdMenuBook } from "react-icons/md";
import { FaGamepad } from "react-icons/fa";
import { useProfileMode } from "../ProfileModeContext";
// Remove: import { web_search } from "../web_search";
...
const ResultsPage: React.FC = () => {
  ...
  const handleConfirmConnect = () => {
    ...
    setConnected((prev: { [key: number]: boolean }) => ({ ...prev, [confirmIdx]: true }));
    // Show toast
