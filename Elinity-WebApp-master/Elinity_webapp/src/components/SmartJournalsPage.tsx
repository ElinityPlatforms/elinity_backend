    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        <div className="sidebar-group main-icons">
          <button className="sidebar-icon" aria-label="Home" onClick={() => navigate('/')}><MdHome /></button>
          <button className="sidebar-icon" aria-label="Favorites" onClick={() => navigate('/your-matches')}><MdFavorite /></button>
          <button className="sidebar-icon" aria-label="Prompt" onClick={() => navigate('/prompt')}><MdAssignment /></button>
          <button className="sidebar-icon" aria-label="Search"><MdSearch /></button>
          <button className="sidebar-icon" aria-label="Messages" onClick={() => navigate('/chat')}><MdMessage /></button>
          <button className="sidebar-icon" aria-label="Games" onClick={() => navigate('/games')}><FaGamepad /></button>
          <button className="sidebar-icon active" aria-label="Journal" onClick={() => navigate('/journal-prompt')}><MdBook /></button>
        </div>
        <div className="sidebar-divider"></div>
        <div className="sidebar-group secondary-icons">
          <button className="sidebar-icon" aria-label="Notifications"><MdOutlineNotificationsNone /></button>
          <button className="sidebar-icon" aria-label="Settings"><MdOutlineSettings /></button>
        </div>
      </nav>
      <div className="sidebar-logout">
        <button className="sidebar-icon red" aria-label="Logout"><MdLogout /></button>
      </div>
    </aside>
  );
};
