...
import { MdHome, MdFavorite, MdAssignment, MdSearch, MdMessage, MdSettings, MdInfo, MdDelete, MdLogout, MdAccessTime, MdOutlineNotificationsNone, MdOutlineSettings, MdChevronLeft, MdPerson } from "react-icons/md";
