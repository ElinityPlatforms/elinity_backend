        ...
        <div style={{
          ...
          <div style={{ gridRow: '1 / span 2', gridColumn: '1', height: '100%' }}>
            <div className="profile-card" style={{ ...cardStyle, height: '100%', textAlign: 'left', padding: 0, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
              <img src="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=facearea&w=400&h=400&facepad=2" alt="Collaborative Team 2" style={{ width: '100%', height: '100%', objectFit: 'cover', position: 'absolute', top: 0, left: 0, zIndex: 1 }} />
          ...
          <div style={{ gridRow: '4', gridColumn: '1', height: '100%' }}>
            <div style={{ ...cardStyle, padding: 0, overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', aspectRatio: '3/4', minHeight: 320, maxHeight: 480 }}>
              <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=800&q=80" alt="Collaborative Workspace" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: 16 }} />
            </div>
          </div>
